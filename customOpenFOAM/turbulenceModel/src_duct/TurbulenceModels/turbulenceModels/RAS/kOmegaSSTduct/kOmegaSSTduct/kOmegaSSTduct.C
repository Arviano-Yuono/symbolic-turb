...
tmp<volScalarField>
kOmegaSSTduct<BasicTurbulenceModel>::kOmegaSSTduct::F1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField>
kOmegaSSTduct<BasicTurbulenceModel>::kOmegaSSTduct::F2() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField>
kOmegaSSTduct<BasicTurbulenceModel>::kOmegaSSTduct::F3() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField>
kOmegaSSTduct<BasicTurbulenceModel>::kOmegaSSTduct::F23() const
{
...
template<class BasicTurbulenceModel>
void kOmegaSSTduct<BasicTurbulenceModel>::correctNut
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTduct<BasicTurbulenceModel>::Pk
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTduct<BasicTurbulenceModel>::epsilonByk
(
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kOmegaSSTduct<BasicTurbulenceModel>::kSource() const
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kOmegaSSTduct<BasicTurbulenceModel>::omegaSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kOmegaSSTduct<BasicTurbulenceModel>::Qsas
(
...
template<class BasicTurbulenceModel>
kOmegaSSTduct<BasicTurbulenceModel>::kOmegaSSTduct
(
...
/********************************************************************************************/
{
	...
	Info<< "Tensor expression being run: " <<endl;
	//ccl: Read the model equation from transportProperties
	Info<< "Reading tensor expression from GEP \n" << endl;
	Info<< "Tensor expression being run: " <<endl;
	wordList zeta1
...
kOmegaSSTduct<BasicTurbulenceModel>::R() const
{
...
template<class BasicTurbulenceModel>
Foam::tmp<Foam::volSymmTensorField>
kOmegaSSTduct<BasicTurbulenceModel>::devRhoReff() const
{
...
kOmegaSSTduct<BasicTurbulenceModel>::divDevRhoReff
(
    volVectorField& U
) const
{
...
//**************************************************************************//
template<class BasicTurbulenceModel>
bool kOmegaSSTduct<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kOmegaSSTduct<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
...
//******************************add by yuan***********************************//
   ...
   label i = 0, j = 0, k = 0, e = 0, f = 0, g = 0;
    nonlinearStress_=2*k_*((evalGeno(zeta1, i, I1, I2, N1, N2, N3))*T1 + (evalGeno(zeta2, j, I1, I2, N1, N2, N3))*T2 + (evalGeno(zeta3, k, I1, I2, N1, N2, N3))*T3);
    Rij_=2*k_*((evalGeno(zeta4, e, I1, I2, N1, N2, N3))*T1 + (evalGeno(zeta5, f, I1, I2, N1, N2, N3))*T2 + (evalGeno(zeta6, g, I1, I2, N1, N2, N3))*T3);
